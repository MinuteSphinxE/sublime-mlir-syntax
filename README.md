# A MLIR .sublime-syntax grammar

![preview](preview.png)

## Sources

Forked from https://github.com/rrbutani/sublime-mlir-syntax, Just for publishing it on sublime text, a big thank :heart: for author!​
